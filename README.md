# Available .VET One-Word Domains (5,622,097)
...
> **Important:** this repository is a **public 9,290-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,097 domains** on the canonical page below.

**Public extract:** 9,290 rows · **Live catalog:** 5,622,097 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/vet?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/vet?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./vet.csv">CSV</a> / <a href="./vet.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .VET search](https://unique.domains/domains/tld/vet?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .VET search](https://unique.domains/domains/tld/vet?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vet_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./vet.csv) or [Download JSON](./vet.json)
...
| ----------------------- | ------------------------------------------------ |
| 9,290-row public sample | 5,622,097 live domains                           |
...
| ------------ | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| event.vet    | available | $52.98    | —             | 96             | 48     | 5      | namecheap        |
| code.vet     | resell    | —         | —             | 72             | 64     | 4      | NameCheap, Inc.  |
...
| startup.vet  | resell    | —         | —             | 82             | 48     | 7      | GoDaddy.com, LLC |
...
| law.vet      | premium   | $780      | $780          | 82             | 48     | 3      | namecheap        |
| forge.vet    | available | $50.99    | $54.99        | 62             | 45     | 5      | name.com         |
| earth.vet    | resell    | —         | —             | 62             | 46     | 5      | GoDaddy.com, LLC |
| hotel.vet    | premium   | $260      | $260          | 70             | 46     | 5      | namecheap        |
| nice.vet     | available | $50.99    | $54.99        | 86             | 44     | 4      | name.com         |
| you.vet      | resell    | —         | —             | 74             | 44     | 3      | Dynadot Inc      |
| map.vet      | premium   | $520      | $520          | 78             | 45     | 3      | namecheap        |
| creator.vet  | available | $50.99    | $54.99        | 70             | 44     | 7      | name.com         |
...
> Unique Domains. *Available .VET One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
